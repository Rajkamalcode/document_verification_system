...
- Drawer name is the customer who is paying the cheque to the company so their name usually appears before sign
- In favor is the entity that is receving the cheque
- IFS code will be in  11-character alphanumeric code usually associated with bank name
- Scan the extracted text properly
